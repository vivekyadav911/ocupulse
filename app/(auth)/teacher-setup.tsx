      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <Card bordered>
          ...
          <Text style={styles.sub}>
            Create the team name your students will choose when they register. Share this team with
            your class. After setup you can run experiments yourself (saved privately) and manage
            the roster on the dashboard.
          </Text>
          <FormField
            label="Your name"
            value={displayName}
