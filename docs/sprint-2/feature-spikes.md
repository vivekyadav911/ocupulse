...
- **Spike:** [`app/_spikes/sqlite.tsx`](../../app/_spikes/sqlite.tsx)
- **Code:** [`services/db/sqlite.ts`](../../services/db/sqlite.ts) — typed DAOs, migrations `001_schema` / `002_indexes`
- **Docs:** [`docs/sprint-3/services.md`](../sprint-3/services.md) (SQLite section)
